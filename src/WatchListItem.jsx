...
class WatchListItem extends Component {
    render() {
        return (
            <div tabIndex="0" className={"column WatchList-ListItem "+(this.props.completed?"completed-item is-2-desktop is-3-tablet is-4-mobile":"up-next-item is-2-desktop is-4-tablet is-6-mobile")} aria-label={(this.props.completed?"Watched: ":"Up Next: ")+this.props.watchListItem.Title+" "+this.props.watchListItem.Year+" "+this.props.watchListItem.Type}>
                <div className="card">
                    <div className="card-image">
                        <figure className="image is-2by3">
                            { (this.props.watchListItem.Poster && this.props.watchListItem.Poster !== "N/A") ?
                            ( <img src={this.props.watchListItem.Poster.replace(/^http:/, 'https:')} alt={this.props.watchListItem.Title + " Poster"} /> ) : 
